...
def getResults():
    ...
    html = urlopen("https://enr.electionsfl.org/BRO/1897/Summary/")
    bsObj = BeautifulSoup(html, "html5lib")
    #ADDED line: Broward makes you specify that you want detailed results in a dropdown
...
def saveToCSV(raceResults):
    ...
    filename = 'BrowardRaceResults.csv'
